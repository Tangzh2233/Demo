...
public class EmailSendUtil {
    ...
    private final static String formName = "17010206231@163.com";//你的邮箱
    private final static String password = "Tzh123456789"; //授权码
    private final static String replayAddress = "17010206231@163.com"; //你的邮箱


    public static void sendMail(Email info)
            throws Exception {
        info.setHost(host);
    ...
    private static Message getMessage(Email info) throws Exception{
        ...
        //消息的发送者
        message.setFrom(new InternetAddress(p.getProperty("mail.smtp.user"),"螳_tang"));
